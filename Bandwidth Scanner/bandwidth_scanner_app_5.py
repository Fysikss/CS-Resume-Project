"""
    Name: bandwidth_scanner_app_5.py
    Author: Noel Onate
    Created: 4/8/26
...
class BandwidthScanner:
    ...
    def display_results(self, download, upload, ping):
        ...
        self.test_results.insert(END, f"          Time: {time_now}\n")
        ...
        self.test_results.insert(END, f"  Upload Speed: {upload:,.2f} Mbps\n")
        self.test_results.insert(END, f"Download Speed: {download:,.2f} Mbps\n")
    ...
    def save_results(self):
        data = self.test_results.get(1.0, END)
    ...
    def create_widgets(self):
        ...
        # Create save button
        self.save_button = Button(self.testing_frame, text="Save", command=self.save_results)
